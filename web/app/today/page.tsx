...
import { api, type Snapshot, dueColor, dueLabel, projectEmoji, type Task, PRIORITY_BADGE_STYLES } from "@/lib/api";
...
function FocusRow({
  ...
  // 2026-07-23 v2 改造: 删左侧竖色条, 只保留 P0/P1/P2/P3 badge。
  //   上一轮按"竖线"加的色条 + badge 双编码跟 TaskRow 不一致 (TaskRow 只有 badge),
  //   用户反馈"割裂"。统一成 badge only: FocusItem / FocusRow / TaskRow 三处 1:1。
  //   FocusRow 是只读展示, badge 是 <span> 跟 FocusItem 一致;
  //   TaskRow 因为是 PriorityMenu trigger, 才是 <button> 可点 (行为差异, 形态一致)。
