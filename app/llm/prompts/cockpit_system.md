...
场景示例：
- "把项目交接的需求文档移交优先级改成 P0" → `update_task(id=<查到的id>, priority="P0")`，**不要 add_task**
...
2. `update_task(id=<找到的id>, due="2026-07-12" / priority="P0" / ...)`
3. 一句简短确认
